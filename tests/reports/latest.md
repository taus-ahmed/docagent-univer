# Accuracy report — 2026-09-16 02:12:05
...
| **accuracy RAW (all adapter widenings off)** | **47.0%** |
| **accuracy CONTENT (container-blind)** | **96.7%** |
| **structure FIDELITY (gold tables returned as tables)** | **100.0%** (17/17; 13 with exact row count) |
...
| outcome counts | {"correct": 383, "missed": 6, "near": 5, "hallucinated": 4, "empty_ok": 12} |

## By document type

| document type | accuracy | halluc. rate | invented | correct | near | renamed | wrong | missed | halluc. |
|---|---|---|---|---|---|---|---|---|---|
| balance_sheet | 91.3% | 0.0% | 0 | 42 | 0 | 0 | 0 | 4 | 0 |
...
| payslip | 94.3% | 5.6% | 0 | 66 | 2 | 0 | 0 | 2 | 4 |
...
| money | 98.1% | 1.2% | 0 | 158 | 0 | 0 | 0 | 3 | 2 |
| number | 100.0% | 0.0% | 0 | 12 | 0 | 0 | 0 | 0 | 0 |
| string | 95.8% | 1.1% | 0 | 183 | 5 | 0 | 0 | 3 | 2 |

## Per document

| document | type | accuracy | raw | halluc. | invented | route | notes |
|---|---|---|---|---|---|---|---|
| BS-2024-Q1 | balance_sheet | 91.3% | 54.3% | 0 | 0 | BS-2024-Q1.pdf: file_type=digital_pdf pages=2 text_len=1242 |  |
...
| PAYSLIP-EMP-0007-APR2024 | payslip | 91.9% | 91.9% | 0 | 0 | PAYSLIP-EMP-0007-APR2024.pdf: file_type=digital_pdf pages=2  |  |
