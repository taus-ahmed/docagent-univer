# Accuracy report — 2026-09-16 06:44:46

- git: `48225ce`  mode: **replay**  repeat: 1
...
| **accuracy RAW (all adapter widenings off)** | **58.4%** |
...
| **hallucination rate (hallucinated / extracted)** | **13.6%** |
| **├ INVENTED — value found NOWHERE in the PDF** | **0** (0.0%) |
| ├ misfiled — real content in a slot gold says is EMPTY | 0 |
| └ out-of-schema — real content, name gold has no field for | 61 *(not a defect)* |
| **DEFECT RATE (invented + misfiled / extracted)** | **0.0%** |
| hallucinated values | 61 |
| near misses | 4 |
| **renamed (right value, different field name)** | **3** (0.8%) |
| outcome counts | {"correct": 381, "hallucinated": 61, "missed": 6, "renamed": 3, "near": 4, "empty_ok": 12} |
...
| purchase_order | 96.8% | 31.1% | 0 | 30 | 1 | 0 | 0 | 0 | 14 |
| sales_invoice | 98.6% | 21.1% | 0 | 70 | 1 | 0 | 0 | 0 | 19 |
...
| string | 94.8% | 24.5% | 0 | 181 | 4 | 3 | 0 | 3 | 61 |
...
| EXP-2024-0081 | expense_report | 98.1% | 13.0% | 7 | 0 | EXP-2024-0081.pdf: file_type=digital_pdf pages=1 text_len=11 |  |
| INV-2024-0031 | sales_invoice | 97.0% | 30.3% | 10 | 0 | INV-2024-0031.pdf: file_type=digital_pdf pages=1 text_len=97 |  |
| INV-2024-0047 | sales_invoice | 100.0% | 31.6% | 9 | 0 | INV-2024-0047.pdf: file_type=digital_pdf pages=1 text_len=10 |  |
...
| PO-2024-0018 | purchase_order | 96.8% | 45.2% | 14 | 0 | PO-2024-0018.pdf: file_type=digital_pdf pages=1 text_len=104 |  |
...
| EXP-2024-0081 | Report No | renamed | EXP-2024-0081 | EXP-2024-0081 |
...
| EXP-2024-0081 | Company Tax ID | hallucinated (misplaced) | None | 47-3821654 |
...
| PO-2024-0018 | Buyer Name Footer | hallucinated (misplaced) | None | Marcus A. Thompson |
| PO-2024-0018 | Buyer Title Footer | hallucinated (misplaced) | None | Purchasing Manager |
...
| PO-2024-0018 | Agreement Statement | hallucinated (misplaced) | None | PO constitutes a binding agreement. |
| PO-2024-0018 | Buyer Email Footer | hallucinated (misplaced) | None | purchasing@nexusglobaltrading.com |
| PO-2024-0018 | Buyer Phone Footer | hallucinated (misplaced) | None | (212) 555-0148 |
