# Accuracy report — 2026-08-23 15:31:17

- git: `71b5907`  mode: **record**  repeat: 1
...
| metric | value |
|---|---|
| **accuracy (correct / gold-valued)** | **97.2%** |
| **accuracy RAW (all adapter widenings off)** | **69.8%** |
| **accuracy CONTENT (container-blind)** | **95.4%** |
| **structure FIDELITY (gold tables returned as tables)** | **100.0%** (17/17; 14 with exact row count) |
| **hallucination rate (hallucinated / extracted)** | **14.4%** |
...
| near misses | 4 |
| **renamed (right value, different field name)** | **4** (1.0%) |
| outcome counts | {"correct": 383, "hallucinated": 66, "renamed": 4, "missed": 2, "near": 4, "wrong": 1, "empty_ok": 12} |
...
| cheque | 72.7% | 35.7% | 0 | 8 | 0 | 1 | 0 | 2 | 5 |
...
| string | 94.8% | 25.0% | 0 | 181 | 4 | 4 | 0 | 2 | 63 |
...
| CHQ-001847 | cheque | 72.7% | 54.5% | 5 | 0 | CHQ-001847.pdf: file_type=digital_pdf pages=1 text_len=501 |  |
...
- EXP-2024-0081 :: Company Tax ID: hallucinated -> None
- EXP-2024-0081 :: Employee Name: correct -> renamed **REGRESSION**
...
- INV-2024-0031 :: Cheque payable to: hallucinated -> None
...
- INV-2024-0031 :: Payment received via wire transfer Feb 10, 2024. Ref: hallucinated -> None
- INV-2024-0031 :: Wire ABA: hallucinated -> None
- INV-2024-0031 :: Wire Account: hallucinated -> None
- INV-2024-0047 :: Cheque Payable To: None -> hallucinated
- INV-2024-0047 :: Notes: None -> hallucinated
- INV-2024-0047 :: Notes Balance Due: hallucinated -> None
- INV-2024-0047 :: Notes Late Payment Interest: hallucinated -> None
- INV-2024-0047 :: Payment Instructions Cheque Payable To: hallucinated -> None
- INV-2024-0047 :: Payment Instructions Wire ABA: hallucinated -> None
- INV-2024-0047 :: Payment Instructions Wire Account: hallucinated -> None
- INV-2024-0047 :: Payment Instructions Wire Bank: hallucinated -> None
...
- IS-2024-Q4 :: Net Revenue: missed -> correct
- IS-2024-Q4 :: Prepared by: None -> hallucinated
- IS-2024-Q4 :: Prepared by: Meridian & Associates CPA: hallucinated -> None
- IS-2024-Q4 :: Total COGS: missed -> correct
- IS-2024-Q4 :: Total Operating Expenses: missed -> correct
- PAYSLIP-EMP-0012-APR2024 :: Net Pay: correct -> wrong **REGRESSION**
- STMT-2024-01 :: EIN: hallucinated -> None
