# Accuracy report — 2026-08-17 23:12:24

- git: `1596f4a`  mode: **record**  repeat: 3
...
|---|---|---|---|---|---|---|
| BS-2024-Q1 | balance_sheet | 80.4% | 41 | 0 | BS-2024-Q1.pdf: file_type=digital_pdf pages=2 text_len=1242 | 24 unstable |
| CHQ-001847 | cheque | 72.7% | 0 | 0 | CHQ-001847.pdf: file_type=digital_pdf pages=1 text_len=501 |  |
| EXP-2024-0081 | expense_report | 7.4% | 39 | 3 | EXP-2024-0081.pdf: file_type=digital_pdf pages=1 text_len=11 | 36 unstable |
| INV-2024-0031 | sales_invoice | 30.3% | 52 | 0 | INV-2024-0031.pdf: file_type=digital_pdf pages=1 text_len=97 | 3 unstable |
| INV-2024-0047 | sales_invoice | 23.7% | 49 | 0 | INV-2024-0047.pdf: file_type=digital_pdf pages=1 text_len=10 | 54 unstable |
| IS-2024-Q4 | income_statement | 100.0% | 0 | 0 | IS-2024-Q4.pdf: file_type=digital_pdf pages=2 text_len=970 |  |
| PAYSLIP-EMP-0007-APR2024 | payslip | 32.4% | 0 | 0 | PAYSLIP-EMP-0007-APR2024.pdf: file_type=digital_pdf pages=2  | FELL BACK TO LEGACY ENGINE; 4 unstable |
| PAYSLIP-EMP-0012-APR2024 | payslip | 97.0% | 60 | 0 | PAYSLIP-EMP-0012-APR2024.pdf: file_type=digital_pdf pages=2  | 85 unstable |
| PO-2024-0018 | purchase_order | 96.8% | 30 | 0 | PO-2024-0018.pdf: file_type=digital_pdf pages=1 text_len=104 | 1 unstable |
...
- BS-2024-Q1 :: field:Net Income YTD Q1: ['"47,353"', 'null']
- BS-2024-Q1 :: field:Total Equity: ['"698,104"', 'null']
- BS-2024-Q1 :: table:Net Income YTD Q1:row_count: ['1', 'null']
- BS-2024-Q1 :: table:Net Income YTD Q1[0].Label: ['"retained earnings"', 'null']
- BS-2024-Q1 :: table:Net Income YTD Q1[0].Value: ['"550,751"', 'null']
- BS-2024-Q1 :: table:Retained Earnings:row_count: ['1', '3']
- BS-2024-Q1 :: table:Retained Earnings[1].Label: ['"net income ytd q1"', 'null']
- BS-2024-Q1 :: table:Retained Earnings[1].Value: ['"47,353"', 'null']
- BS-2024-Q1 :: table:Retained Earnings[2].Label: ['"total equity"', 'null']
- BS-2024-Q1 :: table:Retained Earnings[2].Value: ['"698,104"', 'null']
- BS-2024-Q1 :: table:Total Equity:row_count: ['1', 'null']
- BS-2024-Q1 :: table:Total Equity[0].Label: ['"retained earnings"', 'null']
- BS-2024-Q1 :: table:Total Equity[0].Value: ['"550,751"', 'null']
- BS-2024-Q1 :: table:current_assets:row_count: ['5', '7']
- BS-2024-Q1 :: table:current_assets[5].Amount: ['"143,803"', 'null']
- BS-2024-Q1 :: table:current_assets[5].Label: ['"cash & cash equivalents"', 'null']
- BS-2024-Q1 :: table:current_assets[6].Amount: ['"240,000"', 'null']
- BS-2024-Q1 :: table:current_assets[6].Label: ['"property & equipment (gross)"', 'null']
- BS-2024-Q1 :: table:current_liabilities:row_count: ['5', '6']
- BS-2024-Q1 :: table:current_liabilities[5].Amount: ['"254,800"', 'null']
- BS-2024-Q1 :: table:current_liabilities[5].Label: ['"accounts payable"', 'null']
- BS-2024-Q1 :: table:long_term_liabilities:row_count: ['2', '3']
- BS-2024-Q1 :: table:long_term_liabilities[2].Amount: ['"121,000"', 'null']
- BS-2024-Q1 :: table:long_term_liabilities[2].Label: ['"long-term loan - first national bank"', 'null']
- EXP-2024-0081 :: field:03/15: ['"03/15"', 'null']
- EXP-2024-0081 :: field:03/16: ['"03/16"', 'null']
- EXP-2024-0081 :: field:03/17: ['"03/17"', 'null']
- EXP-2024-0081 :: field:03/18: ['"03/18"', 'null']
- EXP-2024-0081 :: field:Address: ['"142 west 57th street, suite 1800, new york, ny 10019"', 'null']
- EXP-2024-0081 :: field:MERCHANT NAME: ['"nexus global trading llc"', 'null']
- EXP-2024-0081 :: field:Manager: ['"janet wu"', 'null']
- EXP-2024-0081 :: field:NEXUS GLOBAL TRADING LLC: ['"142 west 57th street, suite 1800, new york, ny 10019"', 'null']
- EXP-2024-0081 :: field:Period: ['"march 15-22, 2024"', 'null']
- EXP-2024-0081 :: field:Phone: ['"(212) 555-0148"', 'null']
- EXP-2024-0081 :: field:Purpose: ['"supplier site visit - pacific steel, los angeles"', 'null']
- EXP-2024-0081 :: table:Date:row_count: ['1', '6', '9']
- EXP-2024-0081 :: table:Date[0].Label: ['"03/15"', '"employee"', '"period"']
- EXP-2024-0081 :: table:Date[0].Value: ['"03/15"', '"march 15-22, 2024"', '"marcus a. thompson"']
- EXP-2024-0081 :: table:Date[1].Label: ['"03/15"', '"employee id"', 'null']
- EXP-2024-0081 :: table:Date[1].Value: ['"03/15"', '"emp-0012"', 'null']
- EXP-2024-0081 :: table:Date[2].Label: ['"03/15"', '"department"', 'null']
- EXP-2024-0081 :: table:Date[2].Value: ['"03/15"', '"procurement"', 'null']
- EXP-2024-0081 :: table:Date[3].Label: ['"03/16"', '"manager"', 'null']
- EXP-2024-0081 :: table:Date[3].Value: ['"03/16"', '"janet wu"', 'null']
- EXP-2024-0081 :: table:Date[4].Label: ['"03/16"', '"period"', 'null']
- EXP-2024-0081 :: table:Date[4].Value: ['"03/16"', '"march 15-22, 2024"', 'null']
- EXP-2024-0081 :: table:Date[5].Label: ['"03/16"', '"purpose"', 'null']
- EXP-2024-0081 :: table:Date[5].Value: ['"03/16"', '"supplier site visit - pacific steel, los angeles"', 'null']
- EXP-2024-0081 :: table:Date[6].Label: ['"03/17"', 'null']
- EXP-2024-0081 :: table:Date[6].Value: ['"03/17"', 'null']
- EXP-2024-0081 :: table:Date[7].Label: ['"03/18"', 'null']
- EXP-2024-0081 :: table:Date[7].Value: ['"03/18"', 'null']
- EXP-2024-0081 :: table:Date[8].Label: ['"03/18"', 'null']
- EXP-2024-0081 :: table:Date[8].Value: ['"03/18"', 'null']
- EXP-2024-0081 :: table:NEXUS GLOBAL TRADING LLC[0].Label: ['"merchant name"', '"nexus global trading llc"']
- EXP-2024-0081 :: table:NEXUS GLOBAL TRADING LLC[0].Value: ['"142 west 57th street, suite 1800, new york, ny 10019"', '"nexus global trading llc"']
- EXP-2024-0081 :: table:NEXUS GLOBAL TRADING LLC[1].Label: ['""', '"address"']
- EXP-2024-0081 :: table:NEXUS GLOBAL TRADING LLC[1].Value: ['"(212) 555-0148 | ein: 47-3821654"', '"142 west 57th street, suite 1800, new york, ny 10019"']
- EXP-2024-0081 :: table:NEXUS GLOBAL TRADING LLC[2].Label: ['"employee"', '"phone"']
- EXP-2024-0081 :: table:NEXUS GLOBAL TRADING LLC[2].Value: ['"(212) 555-0148"', '"marcus a. thompson"']
- INV-2024-0031 :: field:Payment Instructions: ['"wire: first national bank of new york"', 'null']
- INV-2024-0031 :: table:NEXUS GLOBAL TRADING LLC[2].Label: ['"payment instructions"', '"steel wire coils grade a 500m"']
- INV-2024-0031 :: table:NEXUS GLOBAL TRADING LLC[2].Value: ['"40"', '"wire: first national bank of new york"']
- INV-2024-0047 :: field:3800 Tech Boulevard Floor 5, Austin, TX 78701: ['"3800 tech boulevard floor 5, austin, tx 78701"', 'null']
- INV-2024-0047 :: field:ABA:: ['"021000021"', 'null']
- INV-2024-0047 :: field:Account:: ['"7743882201"', 'null']
- INV-2024-0047 :: field:Cheque payable to:: ['"nexus global trading llc"', 'null']
- INV-2024-0047 :: field:HDMI 2.1 Cable 2m Pack/5: ['"1,944.00"', '"120 packs $16.20 $1,944.00"']
- INV-2024-0047 :: field:Laptop Cooling Stand Aluminium: ['"2,160.00"', '"80 units $27.00 $2,160.00"']
- INV-2024-0047 :: field:Ms. Sarah Johnson — sjohnson@pinnacleelec.com: ['"ms. sarah johnson - sjohnson@pinnacleelec.com"', 'null']
- INV-2024-0047 :: field:Pinnacle Electronics Corp.: ['"pinnacle electronics corp"', 'null']
- INV-2024-0047 :: field:USB-C Hub 7-Port Model HB-720: ['"150 units $34.50 $5,175.00"', '"5,175.00"']
- INV-2024-0047 :: field:Webcam HD 1080p w/ Mic: ['"2,520.00"', '"60 units $42.00 $2,520.00"']
- INV-2024-0047 :: field:Wire:: ['"first national bank of new york"', 'null']
- INV-2024-0047 :: field:Wireless Mouse M300 Series: ['"200 units $18.75 $3,750.00"', '"3,750.00"']
- INV-2024-0047 :: table:Bill To::row_count: ['3', '4']
- INV-2024-0047 :: table:Bill To:[0].Label: ['"bill to"', '"pinnacle electronics corp"']
- INV-2024-0047 :: table:Bill To:[0].Value: ['""', '"pinnacle electronics corp"']
- INV-2024-0047 :: table:Bill To:[1].Label: ['"3800 tech boulevard floor 5, austin, tx 78701"', '"pinnacle electronics corp"']
- INV-2024-0047 :: table:Bill To:[1].Value: ['""', '"3800 tech boulevard floor 5, austin, tx 78701"']
- INV-2024-0047 :: table:Bill To:[2].Label: ['"3800 tech boulevard floor 5, austin, tx 78701"', '"ms. sarah johnson - sjohnson@pinnacleelec.com"']
- INV-2024-0047 :: table:Bill To:[2].Value: ['""', '"ms. sarah johnson - sjohnson@pinnacleelec.com"']
- INV-2024-0047 :: table:Bill To:[3].Label: ['"ms. sarah johnson - sjohnson@pinnacleelec.com"', 'null']
- INV-2024-0047 :: table:Bill To:[3].Value: ['""', 'null']
- INV-2024-0047 :: table:Description:row_count: ['5', 'null']
- INV-2024-0047 :: table:Description[0].Label: ['"usb-c hub 7-port model hb-720"', 'null']
- INV-2024-0047 :: table:Description[0].Value: ['"150 units $34.50 $5,175.00"', 'null']
- INV-2024-0047 :: table:Description[1].Label: ['"wireless mouse m300 series"', 'null']
- INV-2024-0047 :: table:Description[1].Value: ['"200 units $18.75 $3,750.00"', 'null']
- INV-2024-0047 :: table:Description[2].Label: ['"laptop cooling stand aluminium"', 'null']
- INV-2024-0047 :: table:Description[2].Value: ['"80 units $27.00 $2,160.00"', 'null']
- INV-2024-0047 :: table:Description[3].Label: ['"hdmi 2.1 cable 2m pack/5"', 'null']
- INV-2024-0047 :: table:Description[3].Value: ['"120 packs $16.20 $1,944.00"', 'null']
- INV-2024-0047 :: table:Description[4].Label: ['"webcam hd 1080p w/ mic"', 'null']
- INV-2024-0047 :: table:Description[4].Value: ['"60 units $42.00 $2,520.00"', 'null']
- INV-2024-0047 :: table:NEXUS GLOBAL TRADING LLC[2].Label: ['"bill to"', '"outstanding"']
- INV-2024-0047 :: table:NEXUS GLOBAL TRADING LLC[2].Value: ['""', '"pinnacle electronics corp"']
- INV-2024-0047 :: table:OUTSTANDING:row_count: ['5', 'null']
- INV-2024-0047 :: table:OUTSTANDING[0].Label: ['"usb-c hub 7-port model hb-720"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[0].Value: ['"5,175.00"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[1].Label: ['"wireless mouse m300 series"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[1].Value: ['"3,750.00"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[2].Label: ['"laptop cooling stand aluminium"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[2].Value: ['"2,160.00"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[3].Label: ['"hdmi 2.1 cable 2m pack/5"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[3].Value: ['"1,944.00"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[4].Label: ['"webcam hd 1080p w/ mic"', 'null']
- INV-2024-0047 :: table:OUTSTANDING[4].Value: ['"2,520.00"', 'null']
- INV-2024-0047 :: table:Payment Instructions:row_count: ['3', '4']
- INV-2024-0047 :: table:Payment Instructions[0].Label: ['"wire"', '"wire: first national bank of new york"']
- INV-2024-0047 :: table:Payment Instructions[0].Value: ['""', '"first national bank of new york"']
- INV-2024-0047 :: table:Payment Instructions[1].Label: ['"aba"', '"aba: 021000021 account: 7743882201"']
- INV-2024-0047 :: table:Payment Instructions[1].Value: ['""', '"021000021"']
- INV-2024-0047 :: table:Payment Instructions[2].Label: ['"account"', '"cheque payable to: nexus global trading llc"']
- INV-2024-0047 :: table:Payment Instructions[2].Value: ['""', '"7743882201"']
- INV-2024-0047 :: table:Payment Instructions[3].Label: ['"cheque payable to"', 'null']
- INV-2024-0047 :: table:Payment Instructions[3].Value: ['"nexus global trading llc"', 'null']
- PAYSLIP-EMP-0007-APR2024 :: field:Annual Salary: ['"145000.0"', '"annual salary"']
- PAYSLIP-EMP-0007-APR2024 :: field:Description: ['"description"', 'null']
- PAYSLIP-EMP-0007-APR2024 :: field:Total Deductions: ['"-7070.3"', '"total deductions"']
- PAYSLIP-EMP-0007-APR2024 :: field:Total Earnings: ['"14583.33"', '"total earnings"']
- PAYSLIP-EMP-0012-APR2024 :: field:Pay Period: ['"2024-04-01 - 2024-04-30"', '"april 1-30, 2024"']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table:row_count: ['10', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[0].Amount: ['"7500.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[0].Description: ['"base salary"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[1].Amount: ['"800.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[1].Description: ['"performance bonus"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[2].Amount: ['"-1245.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[2].Description: ['"federal income tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[3].Amount: ['"-515.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[3].Description: ['"social security (6.2%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[4].Amount: ['"-120.35"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[4].Description: ['"medicare (1.45%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[5].Amount: ['"-412.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[5].Description: ['"ny state income tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[6].Amount: ['"-185.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[6].Description: ['"ny city tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[7].Amount: ['"-220.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[7].Description: ['"health insurance (medical)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[8].Amount: ['"-375.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[8].Description: ['"401(k) contribution (5%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[9].Amount: ['"-45.00"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:cbm_table[9].Description: ['"dental & vision"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions:row_count: ['10', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[0].Amount: ['"7500.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[0].Description: ['"base salary"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[1].Amount: ['"800.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[1].Description: ['"performance bonus"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[2].Amount: ['"-1245.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[2].Description: ['"federal income tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[3].Amount: ['"-515.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[3].Description: ['"social security (6.2%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[4].Amount: ['"-120.35"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[4].Description: ['"medicare (1.45%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[5].Amount: ['"-412.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[5].Description: ['"ny state income tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[6].Amount: ['"-185.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[6].Description: ['"ny city tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[7].Amount: ['"-220.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[7].Description: ['"health insurance (medical)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[8].Amount: ['"-375.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[8].Description: ['"401(k) contribution (5%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[9].Amount: ['"-45.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:deductions[9].Description: ['"dental & vision"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings:row_count: ['10', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[0].Amount: ['"7500.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[0].Description: ['"base salary"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[1].Amount: ['"800.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[1].Description: ['"performance bonus"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[2].Amount: ['"-1245.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[2].Description: ['"federal income tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[3].Amount: ['"-515.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[3].Description: ['"social security (6.2%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[4].Amount: ['"-120.35"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[4].Description: ['"medicare (1.45%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[5].Amount: ['"-412.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[5].Description: ['"ny state income tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[6].Amount: ['"-185.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[6].Description: ['"ny city tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[7].Amount: ['"-220.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[7].Description: ['"health insurance (medical)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[8].Amount: ['"-375.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[8].Description: ['"401(k) contribution (5%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[9].Amount: ['"-45.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:earnings[9].Description: ['"dental & vision"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table:row_count: ['10', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[0].Amount: ['"7500.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[0].Description: ['"base salary"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[1].Amount: ['"800.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[1].Description: ['"performance bonus"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[2].Amount: ['"-1245.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[2].Description: ['"federal income tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[3].Amount: ['"-515.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[3].Description: ['"social security (6.2%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[4].Amount: ['"-120.35"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[4].Description: ['"medicare (1.45%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[5].Amount: ['"-412.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[5].Description: ['"ny state income tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[6].Amount: ['"-185.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[6].Description: ['"ny city tax"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[7].Amount: ['"-220.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[7].Description: ['"health insurance (medical)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[8].Amount: ['"-375.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[8].Description: ['"401(k) contribution (5%)"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[9].Amount: ['"-45.0"', 'null']
- PAYSLIP-EMP-0012-APR2024 :: table:table[9].Description: ['"dental & vision"', 'null']
- PO-2024-0018 :: field:Authorised By: ['"janet wu - vp operations"', '"janet wu"']
