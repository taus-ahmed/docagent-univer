...
def infer_template(orchestrator, doc_text_pages, page_images, filename=""):
    ...
    prompt = (
        ...
        "3. fields — the single-value items near the top: identifiers, dates, "
        "names, references. Give each one a short label, in the order they "
        "appear. Use the document's own wording where it has some.\n"
